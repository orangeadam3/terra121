...
public class TerraConfig {
    ...
    public static final String serverOverpass = "https://overpass.kumi.systems/api/interpreter"; //"https://overpass-api.de/api/interpreter"
    ...
    public static final String serverTree = "https://gis-treecover.wri.org/arcgis/rest/services/";
    ...
    public static final String serverTerrain = "https://s3.amazonaws.com/elevation-tiles-prod/terrarium/";
    ...
    @RangeInt(min = 1)
    public static final int osmCacheSize = 1000;
