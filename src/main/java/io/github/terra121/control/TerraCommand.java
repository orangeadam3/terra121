...
public class TerraCommand extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        switch (args.length == 0 ? "" : args[0].toLowerCase()) {
            ...
            case "ou":
                ...
                if (c == null) {
                    throw new CommandException("terra121.error.getcoords");
                } else {
            ...
            case "rstwtr":
                ...
                if (!this.isOp(sender)) {
                    throw new CommandException("terra121.error.notop");
                }
    ...
    private String doInvert(double[] pos, EarthTerrainProcessor terrain, boolean restore) throws CommandException {
        if (!terrain.cfg.settings.osmwater || terrain.osm == null || terrain.osm.water == null) {
            throw new CommandException("terra121.error.nowtr");
        }
        ...
        throw new CommandException(I18n.format("terra121.error.invwtr", region.x, region.y));
    }
